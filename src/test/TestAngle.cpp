...
BOOST_FIXTURE_TEST_CASE(addAndAssignOperator, F)
{
  Angle alpha = Angle::deg(10);
  alpha += alpha;
...
BOOST_FIXTURE_TEST_CASE(multiplyAndAssignOperator, F)
{
  Angle alpha = Angle::deg(22);
  alpha *= 2;
  check_similar(alpha, 44);
  alpha *= 3;
